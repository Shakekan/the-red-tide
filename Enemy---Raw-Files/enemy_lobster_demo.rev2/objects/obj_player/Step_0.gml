...
//var_movement is +1 if moving right, -1 if moving left
...
if (place_meeting(x,y,obj_lobster) || place_meeting(x,y,obj_enemybullet)) {
...
//Death
if (global.hitpoint <= 0) {
	
	//insert death animation and return to menu sorta thing here
